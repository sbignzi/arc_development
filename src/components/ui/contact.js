    ...
    return (
        ...
        {/* <Grid container direction='column' > */}
            ...
            {/* <Grid item container alignItems='center' direction='column' sm>    */}
                ...
                <Grid item style={{marginBottom:'0.5em'}} className={classes.inputContainer}>
                    <TextField label='Name' id='name' className={classes.input}></TextField>
                </Grid>
                <Grid item style={{marginBottom:'0.5em'}} className={classes.inputContainer}>
                    <TextField label='Email' id='email' className={classes.input}></TextField>
                </Grid>
                <Grid item style={{marginBottom:'0.5em'}} className={classes.inputContainer}>
                    <TextField label='Phone' id='phone' className={classes.input}></TextField>
                </Grid>
